...
export default function AboutMe() {
  return (
    <section className="flex flex-col mt-8">
      <p className="text-base md:text-xl text-neutral-900 dark:text-neutral-50">
      ...
      <p className="text-base md:text-xl md:mt-8 mt-4 text-neutral-900 dark:text-neutral-50">
